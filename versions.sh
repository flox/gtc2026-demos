...
check "pip"       "pip --version | awk '{print \$1, \$2}'"
check "uv"        "uv --version"
check "nvcc"      "nvcc --version | grep -oP 'release \K[\d.]+'"
check "GPU Driver" "nvidia-smi --query-gpu=driver_version --format=csv,noheader,nounits"
echo ""
